...
//     // return { id };
//     navigate(`/quest3TierCqrs/${id}`, { replace: true });
//   } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (id) {
        ...
        navigate(`/quest3TierCqrs/${id}`, { replace: true }); // Redirect to the question detail page after successful submission
      }
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Box mb={3}>
          ...
          <Box display="flex" alignItems="center" gap={2}>
            <TextField label="New Option" value={newOption} onChange={(e) => setNewOption(e.target.value)} placeholder="Enter an option" sx={{ flexGrow: 1 }} />
