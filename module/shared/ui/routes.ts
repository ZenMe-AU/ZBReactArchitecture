...
import { publicRoutes, protectedRoutes } from "./path";

export function protectedLayout(routes: RouteConfigEntry[]) {
  return layout("./layouts/protected.tsx", [...routes]);
}
export default [...publicRoutes, protectedLayout(protectedRoutes)] satisfies RouteConfig;
// export default [
