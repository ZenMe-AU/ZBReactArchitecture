...
resource "azurerm_storage_account" "website" {
  ...
  network_rules {
    ...
    bypass                     = ["AzureServices"] # Allow trusted Azure services to bypass network rules
    virtual_network_subnet_ids = [azurerm_subnet.private_endpoint_subnet.id] # Only allow access from this specific subnet
...
resource "azurerm_private_endpoint" "private_endpoint" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = azurerm_storage_account_static_website.website.id
