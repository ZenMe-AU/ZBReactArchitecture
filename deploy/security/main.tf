...
resource "azurerm_cdn_frontdoor_origin" "fd_origin" {
  ...
  # Use the blob endpoint host (excludes https://)
  host_name                     = azurerm_storage_account.website.primary_blob_host
  enabled                       = true
  http_port                     = 80
  https_port                    = 443
  origin_host_header            = azurerm_storage_account.website.primary_blob_host
