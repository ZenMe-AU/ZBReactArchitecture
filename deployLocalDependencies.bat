...
powershell -ExecutionPolicy Bypass -Command "Set-Location -Path './deploy'; ./deploy.ps1 -Stages Install-DevAiTools"
...
pwsh -ExecutionPolicy Bypass -Command "Set-Location -Path './deploy'; ./deploy.ps1 -Stages Install-DevAiTools"
